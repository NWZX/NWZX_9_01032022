 ...
 * @property {string} commentAdmin
 * @property {string} email
 * @property {number} pct
 */

/** @typedef {object} IBillCreateObject
 * @property {string} fileUrl
 * @property {string} key
 */
...
const mockedBills = {
  ...
  /**
   * 
   * @param {{data:any, headers?:Record<string, any>}} bill 
   * @returns {Promise<IBillCreateObject>}
   */
  create(bill) {
  ...
  /**
   * 
   * @param {Partial<IBillObject>} bill 
   * @returns {Promise<IBillObject>}
   */
  update(bill) {
    return Promise.resolve({
